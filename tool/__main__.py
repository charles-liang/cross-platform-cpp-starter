...
def parse_arguments():
    ...
    parser.add_argument('-arch', '--arch', default=None, type=str, help='CPU Architecture <arm/arm64/x86/x86_64/x64>')
...
if __name__ == "__main__":
    ...
    if args.command == 'build':
        project_generator_factory.generate(args.platform, root_path, build_path, args.profile, args.arch)
        build_factory.build(args.platform, root_path, build_path, args.profile, args.arch)
